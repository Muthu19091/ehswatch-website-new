  ...
  return (
    <>
      <style>{`
        ...
        .blog-body h1 { font-family: var(--font-gothic-a1), sans-serif; font-weight: 700; font-size: 1.9rem; color: #0a0f1e; margin: 0 0 1.1rem; letter-spacing: -0.02em; line-height: 1.2; }
