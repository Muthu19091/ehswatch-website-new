...
export default function ProductModules({
  ...
  // Honor the CMS "Cards shown by default" (visible_count) EXACTLY — an editor
  // asking for 4 cards gets 4, not a row-rounded 6 (BUG-187 / BUG-193). A
  // half-empty last row is handled by the white filler cells below
  // (fillSm / fillLg), so no round-up-to-a-full-grid is needed to avoid the old
  // grey-box gap (BUG-185 / BUG-178).
